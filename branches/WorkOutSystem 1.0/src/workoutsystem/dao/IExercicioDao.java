...
public interface IExercicioDao {
	 ...
	 *  os exercicios que estão disponiveis para relacionar a um treino ! 
	 * @param codigoTreino
	 * @param codigoGrupo
	 * @return list
	 * @throws SQLException
	 */
	public abstract List<Exercicio> listarExercicioDisponivel(long codigoTreino, long codigoGrupo)
	throws SQLException;
